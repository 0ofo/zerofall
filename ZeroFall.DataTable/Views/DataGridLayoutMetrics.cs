...
public static class DataGridLayoutMetrics
{
    ...
    public static void RefreshWhenShown(DataGrid grid, DataTableViewModel? table)
    {
        ...
        var rebuilt = !DataGridColumnBuilder.ColumnsMatchDataTable(grid, table);
    ...
    private static void FinishLayoutRefresh(DataGrid grid)
    {
        DataGridScrollChrome.ApplyDeferred(grid);
