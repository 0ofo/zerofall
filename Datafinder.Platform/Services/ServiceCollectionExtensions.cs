using Datafinder.Platform.AppServices;
using Datafinder.Base.Data;
using Datafinder.Base.Events;
using Datafinder.Base.Commands;
using Datafinder.Platform.Services.RelationalDb;
...
public static class ServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddDatafinderCoreServices(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IDatafinderApiService, DatafinderApiService>();
