...
public sealed class SettingsServiceImpl : ISettingsService
{
    ...
    private static IEnumerable<string> GetCandidateDirectories()
    {
        ...
        var list = new[]
        {
            CombineSafe(Environment.SpecialFolder.LocalApplicationData, "ZeroFall"),
            CombineSafe(Environment.SpecialFolder.ApplicationData, "ZeroFall"),
            Path.Combine(Path.GetTempPath(), "ZeroFall")
        };
