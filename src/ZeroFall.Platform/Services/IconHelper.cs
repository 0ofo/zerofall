...
public static class IconHelper
{
    ...
    /// <summary>浏览器相关图标；Semi 12 起 <c>SemiIconGlobe</c> 已改为 <c>SemiIconGlobeStroked</c>。</summary>
    public static StreamGeometry? GetBrowserIcon() =>
        FirstResolved("SemiIconGlobeStroked", "SemiIconGlobeStrokeStroked", "SemiIconGlobeStroke", "SemiIconGlobe")
        ?? GetIcon("SemiIconFile");
