...
public class AiSettings
{
    ...
    /// <summary>按 API Base URL 存储各运营商 API Key，切换运营商时各自保留。</summary>
    [JsonPropertyName("providerApiKeys")]
    ...
    /// <summary>上下文占用达到该百分比后，在一轮对话结束时自动压缩。有效范围 40-80，默认 50。</summary>
    [JsonPropertyName("contextCompressionThresholdPercent")]
    public int ContextCompressionThresholdPercent { get; set; } = 50;
...
{
    /// <summary>代理模式：direct/system/fixed/fluxzy_gateway。默认 fluxzy_gateway。</summary>
    [JsonPropertyName("mode")]
    public string Mode { get; set; } = ProxyModes.FluxzyGateway;
    ...
    /// <summary>是否启用本地 HTTP(S) 拦截代理监听（Burp 风格，流量写入监控表）。默认开启。</summary>
