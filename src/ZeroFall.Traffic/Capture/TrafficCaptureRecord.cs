...
public sealed class TrafficCaptureRecord
{
    ...
    public static TrafficCaptureRecord FromAiFetch(
        string entryId,
        string timeText,
        string method,
        string url,
        ...
        byte[]? responseBodyRaw)
    {
        ...
        {
            EntryId = entryId,
            Source = TrafficCaptureSource.AiFetch,
            TimeText = timeText,
            TabLabel = AiFetchTrafficSource.TabLabel,
            BrowserTabId = AiFetchTrafficSource.BrowserTabId,
            PageSessionId = 0,
            TopLevelUrl = url,
            Method = method,
            Url = url,
...
public static class AiFetchTrafficSource
{
    public const string BrowserTabId = "ai-fetch";
    public const string TabLabel = "AI Fetch";
}
