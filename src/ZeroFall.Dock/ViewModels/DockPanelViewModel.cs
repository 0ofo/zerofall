...
public partial class DockPanelViewModel : ViewModelBase
{
    ...
    partial void OnSelectedTabChanged(DockTabItemViewModel? value)
    {
        _eventBus?.Publish(new DockTabSelectedEvent(Position, value));
    }
    ...
    private void CloseTab(DockTabItemViewModel? tab)
    {
        ...
        var request = new TabCloseRequestedEvent(tab);
    ...
    private static void ReleaseTabContent(DockTabItemViewModel tab)
    {
